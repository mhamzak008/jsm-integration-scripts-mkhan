...
func configureLogger() log.Logger {
	level := configParameters["zabbix2jsm.logger"]
...
func getHttpClient(timeout int) *http.Client {
	...
	var proxyEnabled = configParameters["zabbix2jsm.http.proxy.enabled"]
	var proxyHost = configParameters["zabbix2jsm.http.proxy.host"]
	var proxyPort = configParameters["zabbix2jsm.http.proxy.port"]
	var scheme = configParameters["zabbix2jsm.http.proxy.protocol"]
	var proxyUsername = configParameters["zabbix2jsm.http.proxy.username"]
	var proxyPassword = configParameters["zabbix2jsm.http.proxy.password"]
